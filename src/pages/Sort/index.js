...
const Sort = () => {
    return ( 
        <div className="containerFluid justify-content-center row">
        <div className="row col-11 sectionSearch justify-content-center">
          <p className="col-12 row">
            <span className="sectionSearchTotal col-2">Total Products: ..</span>
          ...
          <form className="sectionSearchForm form-group col-12 row" id="sectionSearchForm">
            ...
            <span className="sectionSearchItem col-4 row">
              <label className="sectionSearchLabel col-4" htmlFor="xSort">Color:</label>
